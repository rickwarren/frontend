                ...
                <div className="chat-widget-user-window">
                                   ...
                                   return (message?.userId1 === user2?.id ? (
                                        <li className="chat-window-other-message" key={index}>
                                            <div className="chat-window-other-avatar-wrapper">
                                                <img src={`http://localhost:3000/upload/${user?.userModel?.profile?.profilePhoto}`} height="50" />
                    ...
                    >
                        <div className="comments-input">
                            <div className="mr-2">
                                <img className="rounded-circle" width="30" src={'http://localhost:3000/upload/' + user?.userModel?.profile ? user?.userModel?.profile?.profilePhoto : ''} alt=""/>
                           </div>
                            <div className="ml-2">
                            <Form.Item
                                name="message"
