...
import { getCorporationByName } from '../../services/api/corporation/corporationApi';
...
const Sponsor: React.FC = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            const result = await getCorporationByName(patharr[2])
            setUser(response);
            setSponsor(result);
            setFileList([
                {
                                                        ...
                                                        <div className="ant-upload-list-item-container">
                                                            <div className="ant-upload-list-item ant-upload-list-item-done">
                                                                <a href="#" className="ant-upload-list-item-thumbnail">
                                                                    <img src={'http://localhost:3000/upload/' + sponsor?.logo} className="ant-upload-list-item-image" />
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
